  ...
  <main> 
    <div class="lista-chat">
      <?php
        ...
        // Consulta para traer los chats del usuario
        $sql = "SELECT chats.*, user.name AS user_name 
        FROM chats 
        JOIN user ON chats.id_user2 = user.id_user 
        WHERE chats.id_user1 = ?";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param('i', $id_user);
        $stmt->execute();
        $resultado = $stmt->get_result();
      ...
      <div class="lista col-5 mx-2"> <!-- LISTA CHATS -->
        ...
        <div class="chat col-7" id="contenedorChat">
            ...
            <div id="chat-contenido">
              ...
              if ($resultado && $resultado->num_rows > 0):
                while ($mensaje = $resultado->fetch_assoc()):
                  ...
                  $claseMensaje = $esMio ? 'mensaje-derecha' : 'mensaje-izquierda col-9';
              ?>
          ...
          <form method="POST" action="../PHP/send_message.php" class="chat-input"> 

            <button type="file" data-bs-toggle="modal" data-bs-target="#modalAdjunto" id="btnFile" class="btn"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#fff"><path d="M720-330q0 104-73 177T470-80q-104 0-177-73t-73-177v-370q0-75 52.5-127.5T400-880q75 0 127.5 52.5T580-700v350q0 46-32 78t-78 32q-46 0-78-32t-32-78v-370h80v370q0 13 8.5 21.5T470-320q13 0 21.5-8.5T500-350v-350q-1-42-29.5-71T400-800q-42 0-71 29t-29 71v370q-1 71 49 120.5T470-160q70 0 119-49.5T640-330v-390h80v390Z"/></svg></button>
            <input type="text" placeholder="Escribe tu mensaje..." id="mensajeInput" name="mensajeInput"></input>
